...
const ListByKeywordService=async (req)=>{
    ...
    try{
        ...
        let data= await ProductModel.aggregate([
            MatchStage, JoinWithBrandStage, JoinWithCategoryStage, UnwindCategoryStage, UnwindBrandStage, ProjectionStage
        ])
        return {status:"success",data:data}
    }catch (e) {
        return {status:"failed",data:e.toString()};
...
const DetailsService=async (req)=>{
    try{
        ...
        let data= await ProductModel.aggregate([
            MatchStage, JoinWithBrandStage, JoinWithCategoryStage, JoinWithDetails, UnwindCategoryStage, UnwindDetailsStage, UnwindBrandStage, ProjectionStage
        ])
        return {status:"success",data:data}
    }catch (e) {
